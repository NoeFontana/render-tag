...
class HealthMonitor:
    ...
    def __init__(self, ports: list[int] | None = None, log_path: Path | None = None):
        self.ports = ports or []
    ...
    def _process_message(self, topic: bytes, payload: bytes):
        ...
        try:
            ...
            snapshot = WorkerSnapshot(
                worker_id=worker_id, telemetry=telemetry, last_seen=time.time(), liveness="HEALTHY"
            )
    ...
    def get_snapshot(self, worker_id: str) -> WorkerSnapshot | None:
