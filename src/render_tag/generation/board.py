...
def compute_charuco_layout(
    ...
    # CV-Standard: Origin is top-left, Y increases downwards in CV space.
    # In Blender local space (Y is up), Top-Left is (min X, max Y).
    # We start at max Y and move downwards (-Y).
