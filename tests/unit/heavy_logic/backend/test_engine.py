...
@pytest.mark.parametrize("config_params, expected_bounces, expected_caustics", [
    (
        {"total_bounces": 5, "diffuse_bounces": 2, "glossy_bounces": 4, "transmission_bounces": 1, "transparent_bounces": 6, "enable_caustics": True},
        {"diffuse_bounces": 2, "glossy_bounces": 4, "transmission_bounces": 1, "transparent_max_bounces": 6, "volume_bounces": 0, "max_bounces": 5},
        True
    ),
    (
        {}, # Defaults
        {"diffuse_bounces": 2, "glossy_bounces": 4, "transmission_bounces": 0, "transparent_max_bounces": 4, "volume_bounces": 0, "max_bounces": 4},
        False
    )
])
