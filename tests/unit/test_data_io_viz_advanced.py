...
def test_visualize_dataset_data_parsing(tmp_path: Path, capsys):
    ...
    with open(csv_path, "w", newline="") as f:
        ...
        writer.writerow(["scene_0001", "42", "tag36h11", "100", "100", "200", "100", "200", "200", "100", "200"])
...
def test_visualize_recipe_complex(mock_plt, tmp_path: Path):
    ...
    recipe = {
        "scene_id": 1,
        "objects": [
            {"name": "board", "type": "BOARD", "location": [0, 0, 0], "rotation_euler": [0, 0, 0], "scale": [1, 1, 1], "properties": {}},
            {"name": "tag1", "type": "TAG", "location": [0.1, 0.1, 0], "rotation_euler": [0, 0, 0.5], "scale": [1, 1, 1], "properties": {"tag_id": 10}},
        ],
        "cameras": [
            {
