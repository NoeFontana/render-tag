...
from render_tag.cli.reporters import RichTerminalReporter, JsonFileReporter
...
def test_rich_terminal_reporter_complex(sample_result):
    ...
    from render_tag.orchestration.result import WorkerMetrics, ErrorRecord
    ...
    calls = [call[0][0] for call in mock_console.print.call_args_list if isinstance(call[0][0], str)]
