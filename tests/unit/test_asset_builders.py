...
def test_registry_build_object():
    ...
    recipe = ObjectRecipe(type="MOCK", name="test_mock", location=[0, 0, 0])
...
def test_registry_missing_builder():
    registry = AssetRegistry()
    recipe = ObjectRecipe(type="MISSING", name="test_missing", location=[0, 0, 0])
...
def test_tag_builder_integration():
    ...
    recipe = ObjectRecipe(
        ...
        properties={"tag_size": 0.16, "tag_family": "tag36h11", "tag_id": 42, "margin_bits": 2},
