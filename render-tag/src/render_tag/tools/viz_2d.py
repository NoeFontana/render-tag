...
from render_tag.schema import SceneRecipe, ObjectRecipe
...
class ShadowRenderer:
    ...
    def render(self, output_path: Optional[Path] = None, show: bool = False):
    ...
    def _draw_tags(self):
        ...
        for obj in self.recipe.objects:
            if obj.type == "TAG":
                ...
                self.ax.text(x, y, str(tag_id), color='white', ha='center', va='center', fontsize=8, fontweight='bold')
    ...
    def _draw_cameras(self):
        for i, cam in enumerate(self.recipe.cameras):
            ...
            arrow_len = 0.5
            self.ax.arrow(pos[0], pos[1], forward[0]*arrow_len, forward[1]*arrow_len, 
    ...
    def _create_rect_patch(self, obj: ObjectRecipe, color, alpha=1.0) -> patches.Rectangle:
        ...
        return patches.Rectangle((bl_x, bl_y), width, height, angle=np.degrees(rot_z), 
