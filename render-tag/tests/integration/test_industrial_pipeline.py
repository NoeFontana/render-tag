...
def industrial_config(tmp_path):
    config = {
        "dataset": {"output_dir": str(tmp_path / "output"), "num_scenes": 1},
        "camera": {
            "resolution": [256, 256],
            "sensor_noise": {"model": "salt_and_pepper", "amount": 0.05, "salt_vs_pepper": 0.5},
        ...
        "tag": {
            "family": "tag36h11",
            "material": {"randomize": True, "roughness_min": 0.5, "roughness_max": 0.9},
        },
    }
