...
def rich_dataset(tmp_path):
    ...
    dataset_dir.mkdir()
    rich_truth = [
        {"image_id": "img1", "tag_id": 0, "distance": 2.5, "angle_of_incidence": 30.0, "lighting_intensity": 100},
        {"image_id": "img2", "tag_id": 1, "distance": 5.0, "angle_of_incidence": 60.0, "lighting_intensity": 80}
    ]
