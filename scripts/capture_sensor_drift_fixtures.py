"""Regenerate pinned SceneRecipe fixtures for the sensor-realism drift gate.

The drift gate (tests/unit/heavy_logic/generation/test_sensor_drift.py)
compares live-compiled recipes to these fixtures. Run this whenever an
intentional change to sensor benchmarks, presets, schema fields, or compiler
paths lands — it overwrites every fixture in-place from the current
compiler output.
...
# pulls bpy / blenderproc. Reuse the test plugin helper.
...
from tests.fixtures.sensor_drift import (  # noqa: E402
    BENCHMARK_CONFIGS,
    CANONICAL_SCENE_IDS,
    CANONICAL_SEED,
    fixture_path,
